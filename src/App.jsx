              ...
              <div className="p-6 md:p-12 space-y-8 md:space-y-10 text-slate-600 leading-relaxed font-light text-base md:text-lg">
                <section>
                  <p className="first-letter:text-4xl md:first-letter:text-5xl first-letter:font-serif first-letter:text-slate-900 first-letter:mr-2 md:first-letter:mr-3 first-letter:float-left">
                    International Conference on Next-Generation Cybersecurity and Applied Artificial Intelligence (NGCAI) is a prestigious global forum that brings together academicians, industry experts, policymakers, and innovators to deliberate on cutting-edge developments at the intersection of Artificial Intelligence and Cybersecurity. In today’s era of rising cyber threats, rapid digitalisation, and widespread adoption of intelligent systems, NGCAI addresses the urgent need for robust and proactive security solutions powered by AI.
                  </p>
                  <p className="mt-4">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="flex items-center gap-4 group">
              ...
              <div className="flex flex-col">
                <span className="font-serif font-bold text-2xl tracking-tighter flex items-center gap-2 transition-colors text-slate-900">
                  NGCAI <span className="font-light italic transition-colors text-slate-400 group-hover:text-slate-600">2026</span>
                </span>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <div className="relative">
                <motion.h1
                  variants={fadeInUp}
                  className="text-4xl md:text-6xl lg:text-7xl font-sans font-bold text-slate-900 leading-[1] md:leading-[0.95] tracking-tighter"
                >
                  <span className="block text-xl md:text-3xl font-sans font-light text-slate-400 mb-2 md:mb-4 tracking-normal">International Conference on</span>
                  Next-Generation <br />
            ...
            >
              ...
              {[
                ...
                { label: "Proceedings", val: "Coming Soon", sub: "To be announced", icon: <BookOpen size={24} className="text-blue-600" /> },
              ...
              <div className="lg:col-span-5 relative h-full">
                <div className="sticky top-24 space-y-8">
                  ...
                  <div className="bg-slate-900 text-white p-8 rounded-sm shadow-xl border-t-4 border-emerald-500">
                    ...
                    <h3 className="text-lg font-serif mb-2">ATLANTIS PRESS (SPRINGER NATURE)</h3>
                    <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                      Publications details coming soon.
                    </p>
        ...
        <div className="container mx-auto px-6 md:px-12">
          <div className="grid lg:grid-cols-4 gap-16 mb-24 border-b border-white/10 pb-16">
            <div className="lg:col-span-2">
              <span className="font-serif font-bold text-3xl text-white mb-8 block">NGCAI 2026</span>
